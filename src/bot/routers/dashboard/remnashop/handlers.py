...
async def on_extra_devices_menu(
    ...
    await dialog_manager.switch_to(DashboardRemnashop.EXTRA_DEVICES)
...
async def on_edit_extra_devices_price(
    ...
    await dialog_manager.switch_to(DashboardRemnashop.EXTRA_DEVICES_PRICE)
...
async def on_extra_devices_manual_price_mode(
    ...
    await dialog_manager.switch_to(DashboardRemnashop.EXTRA_DEVICES_PRICE_MANUAL)
...
async def on_back_to_remnashop(
    ...
    await dialog_manager.switch_to(DashboardRemnashop.MAIN)
