...
Скрипт `install.sh` теперь объединяет функции установки и управления в единый интерактивный интерфейс с использованием клавиш навигации (↑↓ Enter).
...
После установки бота, вы можете управлять им из любой директории:
...
Для прямого управления через Docker Compose (без меню):
