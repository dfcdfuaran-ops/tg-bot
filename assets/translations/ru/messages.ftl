...
msg-db-sync =
    ...
    <blockquote>
    • <b>Из Телеграм бота → Панель</b>
    Данные пользователей из бота будут обновлены в панели Remnawave.
    Если пользователя нет в панели, он будет создан.
    
    • <b>Из Панели → Телеграм бот</b>
    Данные подписок из панели будут обновлены в боте.
    Если пользователя нет в боте, он будет создан.
    </blockquote>

    ⚠️ <b>Внимание:</b> Синхронизация может занять некоторое время.
...
msg-dashboard-settings-balance =
    ...
    <b>💎 Режим баланса:</b>
    <blockquote>
    • <b>Сумма</b> — реферальные награды сразу зачисляются на основной баланс
    • <b>Раздельно</b> — отдельный бонусный баланс с активацией бонусов
    </blockquote>
...
msg-referral-invite-message =
    ...
    <i>ℹ️ Доступные переменные:</i>
    <blockquote>
    • <code>{"{name}"}</code> — название вашего сервиса
    • <code>{"{url}"}</code> — реферальная ссылка пользователя
    </blockquote>

msg-referral-invite-edit =
    <b>✏️ Редактирование приглашения</b>
